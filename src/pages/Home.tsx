        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-2xl text-white/70 font-light mb-6 md:mb-8 leading-relaxed px-2">
              <span className="text-5xl md:text-6xl text-gold font-black leading-none align-middle">"</span> Le <span className="italic">Pinterest</span> de la carte de vœux électronique <span className="text-5xl md:text-6xl text-gold font-black leading-none align-middle">"</span>
            </p>
