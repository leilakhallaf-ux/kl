...
const Header = ({ currentPath = '/' }: HeaderProps) => {
  ...
  return (
    <header className={cn(
      ...
      isScrolled ? "bg-gradient-to-b from-[#3a3a3a]/85 to-[#1a1a1a]/85 backdrop-blur-lg border-b border-gold/30 shadow-lg shadow-black/20" : "bg-gradient-to-b from-[#3a3a3a] to-[#1a1a1a]"
    )}>
