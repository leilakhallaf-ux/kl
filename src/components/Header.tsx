...
const Header = ({ currentPath = '/' }: HeaderProps) => {
  ...
  return (
    <header className={cn(
      ...
      isScrolled ? "bg-gradient-to-r from-[#1a1a1a]/95 via-[#2a2a2a]/95 to-[#1a1a1a]/95 backdrop-blur-md border-b border-gold/20" : "bg-gradient-to-r from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a]"
    )}>
