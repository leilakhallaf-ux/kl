...
const Header = ({ currentPath = '/' }: HeaderProps) => {
  ...
  return (
    <header className={cn(
      ...
      isScrolled ? "bg-gradient-to-b from-[#5a5a5a]/85 to-[#2a2a2a]/85 backdrop-blur-lg border-b border-gold/30 shadow-lg shadow-black/20" : "bg-gradient-to-b from-[#5a5a5a] to-[#2a2a2a]"
    )}>
